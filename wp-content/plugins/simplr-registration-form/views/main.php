...
<form action="?page=simplr_reg_set&regview=main" method="post" id="add-field">
	...
	SREG_Form::related_select(array(
		...
		'required'	=>false,
		'post_type'	=>'page',
		'comment' 	=> __('You can leave this field blank. The default behavior outputs a confirmation on the page which the registration shortcode is save. Use this only if you want to redirect the user elsewhere after registration.','simplr-registration-form')),
