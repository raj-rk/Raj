...
function simplr_send_notifications($atts, $data, $passw) {
	...
	wp_mail($notify, __("A new user registered for", 'simplr-registration-form') . " " . $name, __("A new user has registered for", 'simplr-registration-form') . " " . $name."\r". __("Username", 'simplr-registration-form') . ": $user_name\r" . __("Email", 'simplr-registration-form') . ": $email \r",$headers);
